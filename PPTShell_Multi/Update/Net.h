...
public:
	BOOL DownFile(char* szUrl, char* szPath, char* szFile, char** ppBuff=NULL, void* pWnd=NULL);
	BOOL DownFile(char* szUrl, char* szPath, void* pWnd=NULL);
	BOOL DownData(char* szUrl, char* szPath, char* szFile, char** ppBuff=NULL, void* pWnd=NULL);
