...
public:
	...
	bool				OnGetCloudCourse(void * pParam);
	bool				OnGetCloudPic(void * pParam);
	bool				OnGetCloudVolume(void * pParam);
	bool				OnGetCloudVideo(void * pParam);
	bool				OnGetCloudFlash(void * pParam);
