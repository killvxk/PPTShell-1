...
private:
	...
	void AddPictures(vector<string> files);
	...
	vector<string> m_vRemotePictures;
	...
	void ShowUserContactMode(string strUserContact);
	void ShowContactMode();
	bool IsMailString(string strMail);
	bool IsPhoneString(string strPhone);

	string m_strPic1Path;
	string m_strPic2Path;
	string m_strPic3Path;
	string m_strPic4Path;
	string m_strPic5Path;
	int m_nLoginType;
