...
public:
	...
	BOOL SendSlideThumbOfFile(SOCKET sock, int nConnectType, const string& strPPTFile, int iSlideIdx);
...
protected:
	...
	void UpdateSlideThumbToAllUser(const string &strPPTFileName, int iSlideCnt);
