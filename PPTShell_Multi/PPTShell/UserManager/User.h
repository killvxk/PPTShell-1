...
public:
	...
	void				Login(SOCKET sock, DWORD dwUid, bool bLeader, DWORD dwPermission, int nConnectType, char* szName);
	void				Logoff();
	...
	inline	void		SetName(char* szName)			{	strcpy_s(m_szName, MAX_PATH, szName); }
