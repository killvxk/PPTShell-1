...
protected:
	void	GetHttpData(tstring host, tstring url, int nPort, tstring method, tstring post);
	void	GetHttpFile(tstring host, tstring url, int nPort, tstring method, tstring post);
