...
#include "ThirdParty\ATLRegExp\RegExp.h"
#include "ThirdParty\ATLRegExp\StringProcess.h"
#include <comutil.h>
#include <windows.h>
#include <Winhttp.h>
#include <string>
...
public:
    ...
    inline bool SendHttpRequest(const wstring &httpVerb = L"GET", bool disableAutoRedirect = false, bool isUtf8File = false);
...
bool WinHttpClient::SendHttpRequest(const wstring &httpVerb, bool disableAutoRedirect, bool isUtf8File)
{
                    ...
                    if (bSendRequestSucceed)
                    {
                        ...
                        if (::WinHttpReceiveResponse(hRequest, NULL))
                        {
                            ...
                            if (iLength > 0)
                            {
                                ...
                                if (wideChar != NULL)
                                {
									string strUtf8 = Utf82Str( (LPCSTR)m_pResponse);
