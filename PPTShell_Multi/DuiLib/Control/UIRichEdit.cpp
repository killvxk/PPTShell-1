...
CRichEditUI::CRichEditUI() : m_pTextHost(NULL), m_bVScrollBarFixing(false), m_bWantTab(true), m_bWantReturn(true), 
    ...
    m_iLimitText(cInitTextMax), m_lTwhStyle(ES_MULTILINE), m_bInited(false),m_uButtonState(0),m_dwTipTextColor(0xFFBAC0C5)
{
	m_nLineSpacing = 0;
...
{
	m_sTipText	= pStrTipValue;
}

LPCTSTR CRichEditUI::GetTipText()
{
