...
void CBlackBoarderUI::SetBtnPagePreviousEnable( bool enable )
{
	if(m_pBtnPagePrevious)
	{
		...
		if(enable)
		{
			m_pBtnPagePrevious->SetNormalImage(_T("ScreenTool\\blackboard\\btn_pre_page_normal.png"));
			m_pBtnPagePrevious->SetPushedImage(_T("ScreenTool\\blackboard\\btn_pre_page_press.png"));
		}
		else
		{
			m_pBtnPagePrevious->SetNormalImage(_T("ScreenTool\\blackboard\\btn_pre_page_unenable.png"));
			m_pBtnPagePrevious->SetPushedImage(_T(""));
		}
	}
}
...
void CBlackBoarderUI::SetBtnPageNextEnable( bool enable )
{
	if(m_pBtnPageNext)
	{
		...
		if(enable)
		{
			m_pBtnPageNext->SetNormalImage(_T("ScreenTool\\blackboard\\btn_next_page_normal.png"));
			m_pBtnPageNext->SetPushedImage(_T("ScreenTool\\blackboard\\btn_next_page_press.png"));
		}
		else
		{
			m_pBtnPageNext->SetNormalImage(_T("ScreenTool\\blackboard\\btn_next_page_unenable.png"));
			m_pBtnPageNext->SetPushedImage(_T(""));
		}
	}
}
...
void CBlackBoarderUI::LoadBlackboard()
{
	...
	strConfigPath+=_T("\\Setting\\Blackboard.dat");
...
// bool CBlackBoarderUI::ReadFile( tstring strFilePath,tstring& strContent )
// {
// 	bool result = false;
...
bool CBlackBoarderUI::ReadFile( LPCTSTR lptcsFilePath, CStream** pStream)
{
	...
	if(!fp)
	{
		remove(Str2Ansi(lptcsFilePath).c_str());
		return false;
	}
