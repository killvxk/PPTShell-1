...
#include "NDCefLib/PPTVRDispEvent.h"
...
enum FOLAT_WINDOW_SHOW
{
	GET_FLOAT_WINDOW = 0,
	ADD_SLIDE_WINDOW = 1,
	EXERCISES_WINDOW = 2,
	VR_DISTRIBUTE_WINDOW = 4,
};
...
public:
	...
	BOOL			IsPPTOpening()	{	return m_bOpening;	}
...
protected:
	...
	static DWORD WINAPI SetFocusCefToolThread(LPVOID lpParameter);
	static DWORD WINAPI	MonitoringMenuThread(LPVOID lParam);
	// add slide window
...
protected:
	...
	//ICRVR分发线程事件
	CPPTVRDispEvent       m_nPPTVRDispEvent;
...
public:
	...
	bool OnEventMagicPenOperation( void* pNotify );

//	virtual BOOL OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult);
//	afx_msg void OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized);
	afx_msg void OnSysCommand(UINT nID, LPARAM lParam);
	bool m_bShowTipDialog;
	bool m_bShowUpdateDialog;
};
