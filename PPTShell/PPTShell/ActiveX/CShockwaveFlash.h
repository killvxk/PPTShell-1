...
//#import "C:\\Windows\\SysWOW64\\Macromed\\Flash\\Flash32_18_0_0_194.ocx" no_namespace
// CShockwaveFlash wrapper class

class CShockwaveFlash : public COleDispatchDriver
{
public:
	CShockwaveFlash(){} // Calls COleDispatchDriver default constructor
	CShockwaveFlash(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CShockwaveFlash(const CShockwaveFlash& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
