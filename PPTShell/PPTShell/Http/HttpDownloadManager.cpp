...
BOOL CHttpDownloadManager::Initialize(int nMaxThreadCount /* = 10 */, int nDataThreadCount /*= 2*/)
{
	...
	// set max connection per server
	InternetSetOption(NULL, INTERNET_OPTION_MAX_CONNS_PER_SERVER, (LPVOID)&nMaxThreadCount, 4);
	InternetSetOption(NULL, INTERNET_OPTION_MAX_CONNS_PER_1_0_SERVER, (LPVOID)&nMaxThreadCount, 4);
