...
CComboUI::CComboUI() : m_pWindow(NULL), m_iCurSel(-1), m_uButtonState(0),m_iFont(-1),m_dwTipTextColor(0xFFBAC0C5)
{
...
{
	CControlUI::SetTipText(pstrText);

	NeedParentUpdate();
}

CDuiString CComboUI::GetTipText() const
{
