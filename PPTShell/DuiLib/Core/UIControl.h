...
public:
	...
	//默认提示相关
	virtual void SetTipText(LPCTSTR pStrTipValue);
	...
	bool SetBkImageWithResult(LPCTSTR pStrImage);
	...
	void	SetTransparentable(bool bTransparentable);
	bool	IsTransparentable();
